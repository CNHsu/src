...
lb10=tk.Label(root, text="RTS ",borderwidth=2, relief="groove",pady=5).grid(column=0,row=rowi+9)
lb11=tk.Label(root, text="DSR ",borderwidth=2, relief="groove",pady=5).grid(column=0,row=rowi+10)
