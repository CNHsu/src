...
#include <EEPROM.h> // EEPROM size 4KB
...
int uA_SET1=50;//D50 for 5V source '1' mA, '0'uA, 2019/4/29 update
int uA_SET2=51;//D51 for 4V BAT source '1' mA, '0' uA, 2019/4/29 update
