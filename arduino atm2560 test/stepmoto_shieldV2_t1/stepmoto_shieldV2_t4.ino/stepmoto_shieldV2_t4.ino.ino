...
Adafruit_StepperMotor *myMotor = AFMS.getStepper(200, 1); // forDPW11 set 200,for 28BYJ set 4096
Adafruit_StepperMotor *myMotor2 = AFMS.getStepper(200, 2); // for DPW11 motor set 200
...
//  myMotor->step(10, BACKWARD, INTERLEAVE); 
 ...
 case 'f':
    ...
    myMotor->step(100, FORWARD, MICROSTEP); // for 28BYJ DOUBLE is better
  ...
  case '1':
    ...
    myMotor->step(10, FORWARD, MICROSTEP); // MICROSTEP, 20step ~3mm
  ...
  case '3':
   ...
   // myMotor->step(20, BACKWARD, DOUBLE);
    myMotor2->step(20, FORWARD,SINGLE); //1
    delay(dt);
    myMotor2->step(20, BACKWARD,SINGLE);
    delay(dt);
     myMotor2->step(20, FORWARD,SINGLE); //2
    delay(dt);
     myMotor2->step(20, BACKWARD,SINGLE);
    delay(dt);
    myMotor2->step(20, FORWARD,SINGLE); //3
    delay(dt);
     myMotor2->step(20, BACKWARD,SINGLE);
