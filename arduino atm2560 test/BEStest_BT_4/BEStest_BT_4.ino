...
//              Serial1.listen();
             ...
             break ; 
/******************************************************             
 *  2019-0917 marked below
 *  FFT & Rx for key log check, arduino nano can do it
 */
 /*
    ...
    btrx="";
       ...
       switch (i){
        ...
        case '4': Serial.println("select pcb4(serial5)");
          ...
          switch(i){
            case 's': Serial.println("set stepper speed(rpm) : "+btrx);
                      step_speed = btrx.toInt();
                      motor.setSpeed(step_speed);                      
                      break;
            case 'd': Serial.println("set stepper steps : "+btrx);
                     // step_step =btrx.toInt(); // has issue on negative value
                     btrx.toCharArray(char_array,10);
                     step_step= atoi(char_array);
                     Serial.println(step_step);
                      motor.step(step_step);
                     digitalWrite(31,LOW); 
                     digitalWrite(33,LOW);
                     digitalWrite(35,LOW);
                     digitalWrite(37,LOW); 
                      break;
            case 'r': Serial.println("running");
                      motor.setSpeed(step_speed);
                      motor.step(step_step);
                     digitalWrite(31,LOW); 
                     digitalWrite(33,LOW);
                     ...
                     digitalWrite(37,LOW);                      
                      break;
            case 't': Serial.println("terminal stepper");
                     digitalWrite(31,LOW); 
                     digitalWrite(33,LOW);
                     digitalWrite(35,LOW);
                     digitalWrite(37,LOW);
