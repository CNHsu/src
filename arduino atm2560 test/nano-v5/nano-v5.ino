...
void setup() {
 ...
 // SetPinFrequencySafe(pwm2, frequency2);
  ...
  Serial.write("3S checker board V5\n\r");
 ...
 i=instr[0];
  ...
  switch (i){
   ...
   case 'i'  :Serial.print("LED8=0 \n\r");
             ...
             break ; 
   case 'j'  :Serial.print("**CK LED ");  //check led on/off
             val=0;
             for(i=0;i<10;i++){
