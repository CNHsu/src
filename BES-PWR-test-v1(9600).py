...
import os
root = tk.Tk()
root.title("BES PWR Test TOOL 2019/8/5")
...
lb13=tk.Label(root, text="auto run : ",borderwidth=2, relief="groove",pady=5).grid(column=0,row=rowi+12)
#########################################################
# text output window
#
...
def LED2():
    if sLED2.get() == 1:
        ...
        text_output.insert(tk.END,"\nw BT scan wait 12sec")
        time.sleep(5);
        while ser.in_waiting:# 若收到序列資料…
            data_raw = ser.readline()  # 讀取一行
            data_raw2 = data_raw.decode("utf8","ignore")
            print('AT: ',data_raw2)
            #text_output.insert(tk.END,'AT ',data_raw2,"\n\r")
            text_output.insert(tk.END,data_raw2,"\n\r")
        print("end")
        ser.flushInput()        
    else:
...
# 5V on
    ...
    while ser.in_waiting:# 若收到序列資料…
        ...
        if f !=-1:
            ...
            tflt.set("5V")
            #print('o ',data_raw2)
            text_output.insert(tk.END,'5V on ok ',data_raw2)
            #ser.flushInput()
            break
        else:
            #ser.write(str("8").encode())
...
# 4V on
    ...
    while ser.in_waiting:# 若收到序列資料…
        ...
        if f !=-1:
            ...
            tflt.set("4V")
            #print('o ',data_raw2)
            text_output.insert(tk.END,'4V on ok ',data_raw2)
            #ser.flushInput()
            break
        else:
            #ser.write(str("8").encode())
...
# 5V V
    ...
    while ser.in_waiting:# 若收到序列資料…
        ...
        if f !=-1:
            ...
            tflt.set(data_raw2)
            print('o ',data_raw2)
            text_output.insert(tk.END,'5V read ok ',data_raw2)
            #ser.flushInput()
            break
        else:
            #ser.write(str("8").encode())
...
# 5V uA
    ...
    while ser.in_waiting:# 若收到序列資料…
        ...
        print(">>",data_raw2)
        text_output.insert(tk.END,data_raw2)
        f=data_raw2.find("**5V uA")
        if f !=-1:
            tflt.set("5V uA")
            text_output.insert(tk.END,'5V set uA ok ',data_raw2)
            #ser.flushInput()
            break
        else:
            #ser.write(str("8").encode())
...
# 5V read I
    ...
    while ser.in_waiting:# 若收到序列資料…
        ...
        if f !=-1:
            ...
            tflt.set(data_raw2)
            print('o ',data_raw2)
            text_output.insert(tk.END,'5I read ok ',data_raw2)
            #ser.flushInput()
            break
        else:
            #ser.write(str("8").encode())
...
# 5V mA
    ...
    while ser.in_waiting:# 若收到序列資料…
        ...
        print(">>",data_raw2)
        text_output.insert(tk.END,data_raw2)
        f=data_raw2.find("**5V mA")
        if f !=-1:
            tflt.set("5V mA")
            text_output.insert(tk.END,'5V set mA ok ',data_raw2)
            #ser.flushInput()
            break
        else:
            #ser.write(str("8").encode())
...
# 4V V
    ...
    while ser.in_waiting:# 若收到序列資料…
        ...
        if f !=-1:
            ...
            tflt.set(data_raw2)
            print('o ',data_raw2)
            text_output.insert(tk.END,'4V read ok ',data_raw2)
            #ser.flushInput()
            break
        else:
            #ser.write(str("8").encode())
...
# 4V uA
    ...
    while ser.in_waiting:# 若收到序列資料…
        ...
        print(">>",data_raw2)
        text_output.insert(tk.END,data_raw2)
        f=data_raw2.find("**4V uA")
        if f !=-1:
            tflt.set("4V uA")
            text_output.insert(tk.END,'4V uA set ok ',data_raw2)
            #ser.flushInput()
            break
        else:
            #ser.write(str("8").encode())
...
# 4V read I
    ...
    while ser.in_waiting:# 若收到序列資料…
        ...
        if f !=-1:
            ...
            tflt.set(data_raw2)
            print('o ',data_raw2)
            text_output.insert(tk.END,'4I read ok ',data_raw2)
            #ser.flushInput()
            break
        else:
            #ser.write(str("8").encode())
...
# 4V mA
    ...
    while ser.in_waiting:# 若收到序列資料…
        ...
        print(">>",data_raw2)
        text_output.insert(tk.END,data_raw2)
        f=data_raw2.find("**4V mA")
        if f !=-1:
            tflt.set("4V mA")
            text_output.insert(tk.END,'4V mA set ok ',data_raw2)
            #ser.flushInput()
            break
        else:
            #ser.write(str("8").encode())
...
# 5V off
    ...
    while ser.in_waiting:# 若收到序列資料…
        ...
        if f !=-1:
            ...
            tflt.set("5off")
            #print('o ',data_raw2)
            text_output.insert(tk.END,'5V off ok ',data_raw2)
            #ser.flushInput()
            break
        else:
            #ser.write(str("8").encode())
...
# 4V off
    ...
    while ser.in_waiting:# 若收到序列資料…
        ...
        if f !=-1:
            ...
            tflt.set("4off")
            #print('o ',data_raw2)
            text_output.insert(tk.END,'4V off ok ',data_raw2)
            #ser.flushInput()
            break
        else:
            #ser.write(str("8").encode())
   ...
   # time.sleep(3)
    while ser.in_waiting:# 若收到序列資料…
        ...
        if f !=-1:
            ...
            tflt.set("BT-on")
            #print('o ',data_raw2)
            text_output.insert(tk.END,'BT init ok ',data_raw2)
            #ser.flushInput()
            break
        else:
            #ser.write(str("8").encode())
